...
// person.marsTime()
// person.jupiterTime()
console.log('The time scales' + person.time + 'compared to Earth. If your age is' + person.age + 'then your life expectancy is' + person.lifeExp + 'with' + person.lifeLeft + 'years left to live and are' + person.excessAge + 'past this age!')